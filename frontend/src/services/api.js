/**
 * @file api.js
 * @description Servicio centralizado para manejar peticiones a la API de MiTubo
 * @author Tu Nombre
 * @version 1.0.0
 */
...
export const playlistService = {
  ...
  addVideoToPlaylist: (playlistId, videoId) => API.put(`/playlists/${playlistId}/add/${videoId}`),
  removeVideoFromPlaylist: (playlistId, videoId) => API.put(`/playlists/${playlistId}/remove/${videoId}`),
};
